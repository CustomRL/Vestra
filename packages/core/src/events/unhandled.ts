...
export const UnhandledEvents: Readonly<Partial<Record<GatewayDispatchEvents, string>>> = {
  ...
  INVITE_CREATE: 'No structure. Invite is not modelled.',
  INVITE_DELETE: 'No structure. Invite is not modelled.',
  STAGE_INSTANCE_CREATE: 'No structure. StageInstance is not modelled.',
  STAGE_INSTANCE_UPDATE: 'No structure. StageInstance is not modelled.',
  STAGE_INSTANCE_DELETE: 'No structure. StageInstance is not modelled.',
  MESSAGE_REACTION_ADD: 'No structure. Reaction is not modelled.',
  MESSAGE_REACTION_REMOVE: 'No structure. Reaction is not modelled.',
  MESSAGE_REACTION_REMOVE_ALL: 'No structure. Reaction is not modelled.',
  MESSAGE_REACTION_REMOVE_EMOJI: 'No structure. Reaction is not modelled.',
